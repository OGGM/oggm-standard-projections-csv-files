...
](notebooks/global_glacier_volume_until2100_common_running_2100.png)

![Figure 2: Global glacier volume from 2000 to 2300 relative to 2020 (in %) only for CMIP6 by using the common running glaciers until 2100 and 2300. Note that the smaller GCM ensemble until 2300 is rather "hotter" than the more representative ensemble until 2100](notebooks/global_glacier_volume_until2300_common_running_2100_2300.png)
